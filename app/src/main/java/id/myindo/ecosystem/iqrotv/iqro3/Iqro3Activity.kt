package id.myindo.ecosystem.iqrotv.iqro3
...
import id.myindo.ecosystem.iqrotv.adapters.Iqro3PagerAdapter
import id.myindo.ecosystem.iqrotv.adapters.IqroPagerAdapter
import id.myindo.ecosystem.iqrotv.databinding.ActivityIqro3Binding
import id.myindo.ecosystem.iqrotv.iqro2.Iqro2Page1Fragment

class Iqro3Activity : AppCompatActivity(), Iqro3Page1Fragment.OnRowClickListener{

    private lateinit var binding: ActivityIqro3Binding
    private lateinit var viewPager: ViewPager2
    private lateinit var adapter: Iqro3PagerAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityIqro3Binding.inflate(layoutInflater)
        ...
        adapter = Iqro3PagerAdapter(this)
...
//            4 -> getSoundResourceForPage5(currentRow)
    ...
    private fun showPopupWithText(ayat: List<String>) {
        ...
        if (fragment is Iqro3Page1Fragment) {
            when (ayat.size) {
                1 -> {
                    popupTextView1.text = ""
                    popupTextView2.text = ""
    ...
    override fun getAyatText(index: Int): List<String> {
        ...
        return when (fragment) {
            is Iqro3Page1Fragment -> fragment.getAyatText(index)
            else -> listOf("")
        }
    }
    ...
    private fun highlightCurrentRow(page: Int, row: Int, prevRow: Int, highlight: Boolean) {
        ...
        when {
            page == 0 && fragment is Iqro3Page1Fragment -> fragment.highlightRow(row, prevRow, highlight)
        }
    }
