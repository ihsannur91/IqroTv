...
class Iqro6Page4Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_iqro6_page4, container, false)
        ...
        iqraOnePageOne[1] = listOf(view.findViewById(R.id.ayat7),view.findViewById(R.id.ayat8))
