package id.myindo.ecosystem.iqrotv.iqro2
...
import id.myindo.ecosystem.iqrotv.adapters.Iqro2PagerAdapter
import id.myindo.ecosystem.iqrotv.adapters.IqroPagerAdapter
import id.myindo.ecosystem.iqrotv.databinding.ActivityIqro2Binding

class Iqro2Activity : AppCompatActivity(),
    Iqro2Page1Fragment.OnRowClickListener{

    private lateinit var binding:ActivityIqro2Binding
    private lateinit var viewPager: ViewPager2
    private lateinit var adapter: Iqro2PagerAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityIqro2Binding.inflate(layoutInflater)
        ...
        adapter = Iqro2PagerAdapter(this)
...
//            4 -> getSoundResourceForPage5(currentRow)
    ...
    private fun showPopupWithText(ayat: List<String>) {
        ...
        if (fragment is Iqro2Page1Fragment) {
            when (ayat.size) {
                1 -> {
                    popupTextView1.text = ""
                    popupTextView2.text = ""
    ...
    override fun getAyatText(index: Int): List<String> {
        ...
        return when (fragment) {
            is Iqro2Page1Fragment -> fragment.getAyatText(index)
            else -> listOf("")
        }
    }
    ...
    private fun highlightCurrentRow(page: Int, row: Int, prevRow: Int, highlight: Boolean) {
        ...
        when {
            page == 0 && fragment is Iqro2Page1Fragment -> fragment.highlightRow(row, prevRow, highlight)
        }
    }
