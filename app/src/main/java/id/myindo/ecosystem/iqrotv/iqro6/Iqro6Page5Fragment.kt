...
class Iqro6Page5Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_iqro6_page5, container, false)
        ...
        iqraOnePageOne[2] = listOf(view.findViewById(R.id.ayat5))
        iqraOnePageOne[3] = listOf(view.findViewById(R.id.ayat6))
        iqraOnePageOne[4] = listOf(view.findViewById(R.id.ayat7))
        iqraOnePageOne[5] = listOf(view.findViewById(R.id.ayat8))
        iqraOnePageOne[6] = listOf(view.findViewById(R.id.ayat9),view.findViewById(R.id.ayat10))
        iqraOnePageOne[7] = listOf(view.findViewById(R.id.ayat11))
