package id.myindo.ecosystem.iqrotv.iqro5
...
import id.myindo.ecosystem.iqrotv.adapters.Iqro5PagerAdapter
import id.myindo.ecosystem.iqrotv.databinding.ActivityIqro5Binding
import id.myindo.ecosystem.iqrotv.iqro2.Iqro2Page1Fragment

class Iqro5Activity : AppCompatActivity(),Iqro5Page1Fragment.OnRowClickListener {

    private lateinit var binding: ActivityIqro5Binding
    private lateinit var viewPager: ViewPager2
    private lateinit var adapter: Iqro5PagerAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityIqro5Binding.inflate(layoutInflater)
        ...
        adapter = Iqro5PagerAdapter(this)
...
//            4 -> getSoundResourceForPage5(currentRow)
    ...
    private fun getSoundResourceForPage1(row: Int): Int {
        return when (row) {
            0 -> if (voiceActor == "male") R.raw.f_full_iqro5_halaman1_baris1 else R.raw.f_full_iqro5_halaman1_baris1
            1 -> if (voiceActor == "male") R.raw.f_full_iqro5_halaman1_baris2 else R.raw.f_full_iqro5_halaman1_baris2
            2 -> if (voiceActor == "male") R.raw.f_full_iqro5_halaman1_baris3 else R.raw.f_full_iqro5_halaman1_baris3
            3 -> if (voiceActor == "male") R.raw.f_full_iqro5_halaman1_baris4 else R.raw.f_full_iqro5_halaman1_baris4
            4 -> if (voiceActor == "male") R.raw.f_full_iqro5_halaman1_baris5 else R.raw.f_full_iqro5_halaman1_baris5
            5 -> if (voiceActor == "male") R.raw.f_full_iqro5_halaman1_baris6 else R.raw.f_full_iqro5_halaman1_baris6
            6 -> if (voiceActor == "male") R.raw.f_full_iqro5_halaman1_baris7 else R.raw.f_full_iqro5_halaman1_baris7
            7 -> if (voiceActor == "male") R.raw.f_full_iqro5_halaman1_baris8 else R.raw.f_full_iqro5_halaman1_baris8
            else -> -1
        }
    }
    ...
    private fun showPopupWithText(ayat: List<String>) {
        ...
        if (fragment is Iqro5Page1Fragment) {
            when (ayat.size) {
                1 -> {
                    popupTextView1.text = ""
                    popupTextView2.text = ""
    ...
    override fun getAyatText(index: Int): List<String> {
        ...
        return when (fragment) {
            is Iqro5Page1Fragment -> fragment.getAyatText(index)
            else -> listOf("")
        }
    }
    ...
    private fun highlightCurrentRow(page: Int, row: Int, prevRow: Int, highlight: Boolean) {
        ...
        when {
            page == 0 && fragment is Iqro5Page1Fragment -> fragment.highlightRow(row, prevRow, highlight)
        }
    }
