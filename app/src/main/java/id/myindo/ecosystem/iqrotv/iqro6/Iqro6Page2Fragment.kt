...
class Iqro6Page2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_iqro6_page2, container, false)
        ...
        iqraOnePageOne[6] = listOf(view.findViewById(R.id.ayat13),view.findViewById(R.id.ayat14))
        iqraOnePageOne[7] = listOf(view.findViewById(R.id.ayat15),view.findViewById(R.id.ayat16))
